...
<li>
  <a href={post.slug} class="text-lg text-blue-600 hover:underline flex flex-row items-center">
    <div class="w-3 h-3"><FaLink /></div>
    <span>{post.title}</span>
  </a>

  <div class="flex flex-row items-center gap-0.5 text-gray-500 text-sm">
